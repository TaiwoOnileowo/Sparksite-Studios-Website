...
const FeedbackCard = ({ content, name, title, img }) => {
  const reviewCard =
    window.location.pathname === "/" ? "review-card1" : "review-card2";
  return (
    <div
      className={`flex md:justify-between flex-row flex-wrap md:flex-col px-6 xs:px-10 py-6 xs:py-12 rounded-[20px] max-w-[200px] xs:max-w-[300px] md:max-w-[345px] md:mr-10 sm:mr-5 mr-0 my-5 ${reviewCard}`}
    >
      <img
        src={quotes}
        alt="double_quotes"
