...
const Navbar = () => {
  ...
  return (
    <>
      ...
      >
        ...
        <ul className="list-none md:flex hidden justify-end items-center flex-1">
          ...
          <a href={buttonLinks[0].link}>
            <button className="py-3 px-4 bg-navbar font-roboto btn font-medium text-[18px] text-white outline-none rounded-full">
              Request A Proposal
            </button>
          </a>
        </ul>
        ...
        <div className="md:hidden flex flex-1 justify-end items-center">
          ...
          >
            <ul className="list-none flex justify-center items-center flex-1 flex-col">
              ...
              <a href={buttonLinks[0].link}>
                <button className="py-2 ss:py-4 px-2 ss:px-4 bg-navbar font-roboto btn font-medium text-[12px] xs:text-[14px] ss:text-[16px] text-white outline-none rounded-full">
                  Request A Proposal
                </button>
              </a>
            </ul>
      ...
      <div className={`${toggle ? "hidden" : "block"} top-[90px] xs:top-[119px] scroll-watcher`}></div>
    </>
  );
};
