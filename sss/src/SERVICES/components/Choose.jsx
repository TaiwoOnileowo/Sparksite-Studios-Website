...
const Choose = () => {
  return (
    <section className={`flex md:flex-row flex-col`}>
      ...
      <div className={`${layout.sectionInfo}  pt-12 md:pt-44 md:pl-16 px-4 max-w-[650px] md:max-w-[650px]`}>
      ...
      <div className={`flex justify-center md:pr-[40px] md:pl-16 mr-0 mt-0 w-[720px] h-[350px] md:h-[550px] pt-12 md:pt-32`}>
        <img src={choose} alt="card" className='w-[100%]' loading="lazy" />
      </div>
      </div>
    </section>
  )
