...
const Transform = () => {
  return (
    <section id='product' className={`flex md:flex-row flex-col`}>
      ...
      <div className={`flex justify-center mr-0 md:mt-0 md:pl-[60px] md:pr-14 w-full md:max-w-[750px] sm:h-[400px] h-[320px] md:h-[550px] md:pt-32`}>
        <img src={transform} alt="Transform Business Image" className='w-[100%]' loading="lazy" />
      </div>
     <div className={`${layout.sectionInfo} md:pr-16 pt-16 md:pt-[125px] justify-center items-center flex px-4 flex-col md:justify-normal max-w-[650px] md:max-w-[750px]`}>
